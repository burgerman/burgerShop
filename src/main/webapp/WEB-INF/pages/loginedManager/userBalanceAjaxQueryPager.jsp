   ...
   function showModel(iframeUrl){
     ...
     function  doAjaxQuery(){
    	 $.ajax({
    	     ...
    	     url: "${basePath}UserBalanceQueryPagerServlet",//服务器url
    ...
    function parseJsonData(data){
    	...
    	$.each(data,function(index,eachVal) { 
    		...
    		strResult += "<td>";
    		strResult += eachVal.user_charge;
    		strResult += "</th>";
    	
    		strResult += "<td>";
    		strResult += eachVal.user_pay;
    		strResult += "</th>";
    	    
    		strResult += "<td>";
    		strResult += eachVal.user_change;
    		strResult += "</th>";
    		
    		
    		strResult += "<td>";
    		strResult += eachVal.user_time;
    		strResult += "</th>";
				...
				<div class="row">
					...
					<div class="col-md-6">
						<form class="form-horizontal"
							action="${basePath}TopupServlet" method="post">
							<div class="form-group"></div>
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">帐号</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="userAccount"
										name="user_account" placeholder="请输入用户帐号">
								</div>
                                <label for="inputEmail3" class="col-sm-2 control-label">姓名</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="userName"
										name="user_name" placeholder="请输入用户姓名">
								</div>
								
								</div>
							
							    <label for="inputEmail3" class="col-sm-2 control-label">应缴费用</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="userCharge"
										name="user_charge" placeholder="请输入应缴费用">
								</div> 
								
								<label for="inputEmail3" class="col-sm-2 control-label">收费</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="userPay"
										name="user_pay" placeholder="请输入收费">
								</div>
								
								<label for="inputEmail3" class="col-sm-2 control-label">找零</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="userChange"
										name="user_change" placeholder="请输入找零">
								</div>
							
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">缴费时间</label>
								<div class="col-sm-4">
									<!-- <input type="text" id="" name=""
										placeholder="请选择缴费时间" data-date-format="yyyy-mm-dd hh:ii:ss"> -->
									<input type="date" class="form-control" id="userTime"
										name="user_time" placeholder="请选择缴费时间">
								</div>

								
							</div>
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">操作员账户</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="oprAccount"
										name="opr_account" placeholder="请输入操作员账户">
								</div>
