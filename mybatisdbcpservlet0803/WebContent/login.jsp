						...
						<div class="col-md-6">
							<form class="form-horizontal" action="UserLoginServlet" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" id="txtUserName" name="txtUserName" class="form-control" placeholder="请输入姓名">
									</div>
							...
							<input type="radio" name="txtNick" id="txtNick" onclick="sbm2;" value="学生"/> 学生
                           <input type="radio" name="txtNick" id="txtNick" onclick="sbm1;" value="老师"/> 老师
